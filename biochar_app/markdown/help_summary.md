## Directions for use of the options in the Summary Statistic tab
...
- Click "Update Plots" to refresh the Raw and Ratio plots.

- Zooming or panning on one plot will sync the other.

- Use the "Download Summary" button to export what you see.
