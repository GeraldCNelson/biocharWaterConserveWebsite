...
def rename_logger_columns(df, logger_name):
    """
    Summary of the rename_logger_columns function.
...
def read_logger_data(name, year):
    """
    Summary of the read_logger_data function.
...
def merge_all_loggers(year):
    """
    Summary of the merge_all_loggers function.
...
def replace_bad_values(df):
    """
    Summary of the replace_bad_values function.
...
def add_swc(df):
    """
    Summary of the add_swc function.
...
def calculate_ratios(df):
    """
    Summary of the calculate_ratios function.
...
def aggregate(df, year):
    """
    Summary of the aggregate function.
...
def save_outputs(year, aggregated):
    """
    Summary of the save_outputs function.
...
def process_logger_and_climate_data(year):
    """
    Summary of the process_logger_and_climate_data function.
